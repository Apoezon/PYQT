...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonPlainTextEdit.clicked.connect(self.onPushButtonPlainTextEditClicked)  # TODO подключить слот для вывода текста из plainTextEdit в plainTextEditLog при нажатии на кнопку
        ...
        self.spinBox.textChanged.connect(self.spinBoxChanged)  # TODO подключить слот для вывода значения в plainTextEditLog при изменении значения в spinBox
        self.dateTimeEdit.dateTimeChanged.connect(self.dateTimeEditChanged) # TODO подключить слот для вывода датывремени в plainTextEditLog при изменении датывремени в dateTimeEdit
